...
| `packaging/` | PyInstaller, Inno, seed, icon, fonts |
| `themes/Default/` | Default theme (seeded into AppData) |
...
- `THEME: Default`, `DISPLAY_ORIENTATION: portrait|landscape`
...
Third-party fonts under `packaging/fonts/` keep their own licenses (JetBrains Mono / OFL).
