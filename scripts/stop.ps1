# Stop the lcd-monitor-mini product / vendor monitor processes.
...
Get-CimInstance Win32_Process -Filter "Name = 'python.exe' OR Name = 'pythonw.exe' OR Name = 'lcd-monitor-mini.exe'" -ErrorAction SilentlyContinue |
    Where-Object {
        $_.CommandLine -match 'lcd-monitor-mini|turing-lcd|turing-smart-screen-python|app\.main|show_calibration|smoke_test' -or
